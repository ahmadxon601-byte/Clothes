  ...
  try {
    ...
    if (
      ...
      try {
        ...
        if (reviewSupport.hasMarketingCampaignId && pending.marketing_campaign_id !== undefined) {
          applyVals.push(pending.marketing_campaign_id);
          applyFields.push(`marketing_campaign_id = $${applyVals.length}`);
        }
