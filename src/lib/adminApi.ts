...
export const adminApi = {
  ...
  checkTelegramAccess: (initData: string, signal?: AbortSignal) =>
  ...
  createCategory: (payload: { name: string; name_uz?: string; name_ru?: string; name_en?: string; slug: string; parent_id?: string | null; sticker?: string | null }) =>
    request('/api/admin/categories', { method: 'POST', body: JSON.stringify(payload) }),
  updateCategory: (id: string, payload: { name?: string; name_uz?: string; name_ru?: string; name_en?: string; slug?: string; parent_id?: string | null; sticker?: string | null }) =>
