...
export function BottomNav() {
    ...
    return (
        <div className="fixed bottom-5 left-1/2 -translate-x-1/2 w-[92%] max-w-[360px] h-[56px] bg-[var(--color-nav-bg)] rounded-[28px] z-50 shadow-[0_6px_25px_rgba(0,0,0,0.12)] border border-[var(--color-nav-border)] backdrop-blur-lg">
                        ...
                        >
                            {isActive && (
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="w-10 h-10 bg-[var(--color-nav-active-bg)] rounded-full shadow-[0_4px_12px_rgba(26,229,80,0.25)] animate-in zoom-in duration-300" />
                                </div>
                            )}
                            <Icon
                                size={18}
