    ...
    return (
        <section ref={ref as React.RefObject<HTMLElement>} className={cn('mx-auto max-w-[1280px] px-6 md:px-10 py-12 md:py-16 transition-all duration-700', visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6')}>
            <div className="mb-8">
                ...
                <h1 className="mt-1.5 font-[family-name:var(--font-playfair)] text-[clamp(2rem,5vw,3.5rem)] font-black tracking-tight text-[#111111]">{w.clothingPage.title}</h1>
            </div>
            <div className="mb-5">
                <div className="flex h-11 items-center gap-2.5 rounded-full border border-black/10 bg-white px-4">
