    ...
    return (
        <div id="home" className="w-full">
            ...
            >
                <div className="mb-7 flex items-end justify-between">
                    <div>
                        ...
                        <h2 className="mt-1.5 font-[family-name:var(--font-playfair)] text-[clamp(1.8rem,4vw,3rem)] font-black tracking-tight text-[#111111]">
            ...
            <section
                ...
                className={cn(
                    'bg-white py-14 md:py-20 transition-all duration-700',
            ...
            >
                <div className="mx-auto max-w-[1280px] px-6 md:px-10">
                    <div className="flex flex-wrap items-end justify-between gap-5 mb-8">
                        ...
                        <div className="no-scrollbar flex w-full flex-nowrap items-center gap-2 overflow-x-auto border-b border-black/10 pb-2">
                            {CATEGORIES.map((cat) => (
                                <button
                                    key={cat}
                    ...
                    <div className="grid grid-cols-1 gap-4 min-[460px]:grid-cols-2 lg:grid-cols-4">
                        {featuredProducts.map((product) => {
                            ...
                            return (
                                <div
                                    key={product.id}
                                    className="group rounded-3xl border border-black/5 bg-[#f8f9fb] p-3 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_30px_55px_-25px_rgba(0,0,0,0.25)]"
                                >
            ...
            >
                ...
                <div className="pointer-events-none absolute -right-24 bottom-0 h-80 w-80 rounded-full bg-[#00c853]/10 blur-[80px]" />
                <div className="relative mx-auto max-w-[1280px] px-6 md:px-10 text-center">
                    <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-[#8af9b3]">{w.home.premiumOffer}</p>
                    <h3 className="mt-4 font-[family-name:var(--font-playfair)] text-[clamp(2rem,5vw,4.5rem)] font-black leading-tight text-white">
                        {w.home.firstOrderOff}
                    </h3>
                    <p className="mt-5 mx-auto max-w-lg text-[15px] leading-7 text-white/60">
                        {w.home.saleDesc}
                    </p>
                    <Link
                        href={WEB_LINKS.SHOP}
