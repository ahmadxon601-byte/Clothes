...
import { Facebook, Globe, Heart, Instagram, Moon, Search, Sun, User, Youtube } from 'lucide-react';
                                            ...
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    settings.language === code
                                                        ...
                                                        : 'text-[#111111] hover:bg-white/70 dark:text-white dark:hover:bg-white/10',
                                                )}
                                            >
                    ...
                    <div className="mx-auto w-full max-w-[1280px] px-4 py-10 md:py-14">
                        <div className="grid gap-10 border-b border-black/10 pb-10 dark:border-white/10 md:grid-cols-[1.2fr_1fr_1fr_1fr]">
                            <div>
                                ...
                                <p className="mt-3 max-w-sm text-[14px] leading-7 text-[#6b7280] dark:text-[#9ca3af]">
                                    {w.footer.desc}
                                </p>
                        ...
                        <div className="mt-10 grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
                            ...
                            <div className="flex w-full max-w-md items-center gap-2 rounded-full border border-black/10 bg-[#f8f9fb] p-2 dark:border-white/10 dark:bg-white/5">
                                <input
                                    type="email"
                                    placeholder={w.footer.emailPlaceholder}
                                    className="h-10 w-full bg-transparent px-3 text-[14px] text-[#111111] outline-none placeholder:text-[#9ca3af] dark:text-white"
                                />
                        ...
                        <p className="mt-8 text-[12px] text-[#9ca3af] dark:text-[#6b7280]">&copy; {new Date().getFullYear()} Clothes Marketplace. {w.footer.rights}</p>
                    </div>
                </footer>
            </div>
        );
